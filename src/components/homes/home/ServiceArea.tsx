...
const services = [
  { icon: "trending_up", title: "Sector-Based Suggestions", description: "AI-curated top coins from DeFi, Gaming, AI, Layer-2 and other sectors" },
  { icon: "analytics", title: "Market Analysis", description: "Real-time price data, volume analysis & technical indicators for 200+ coins" },
  { icon: "sentiment_very_satisfied", title: "Sentiment Analysis", description: "Track sentiment shifts, identify bullish/bearish trends & make smart trades" },
  { icon: "security", title: "Risk Assessment", description: "Analyze fundamentals, liquidity & market cap for safe investments" },
  { icon: "bolt", title: "Easy Commands", description: "Simple Telegram commands—no technical knowledge needed" },
];
...
const ServiceArea = () => {
  ...
  return (
    <>
      <div className="latest-service-wrapper bg-secondary py-5" style={{ position: 'relative' }}>
        <SvgBgDecorator side="right" size="40%" opacity={0.1} />
          ...
          <div className="row g-4 align-items-end">
            <div className="col-12 col-sm-6">
              <div className="section-heading">
                <h2 className="mb-0">Bot Features & Capabilities</h2>
              </div>
            </div>
