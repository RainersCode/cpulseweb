          ...
          <div className="container">
            ...
            <div className={`collapse navbar-collapse justify-content-end ${menuOpen ? 'show' : ''}`} id="vorixNav">
              <ul className="navbar-nav navbar-nav-scroll">
                {menu_data.map((item, i) => (
                  ...
                  onMouseLeave={() => setNavTitle("")}>
                    ...
                    {item.has_dropdown && 'sub_menus' in item &&
                      <ul className="vorix-dd-menu" style={{ display: navTitle === item.title ? 'block' : 'none' }}>
                        {(item as any).sub_menus.map((sub_menu: any, index: number) => (
              ...
              <div className="d-flex align-items-center">
                ...
                <Link className="btn btn-primary" href="https://t.me/CryptoOleBot" target="_blank">
                <span>Start Bot</span><span>Start Bot</span>
              </Link>
